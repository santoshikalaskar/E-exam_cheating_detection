    ...
    def StartWebCam(self):
        while True:
            ...
            for face in self.faces:
                ...
                for landmark_points in range(0, 68):
                    ...
                    cv2.putText(self.frame, "Looking at Right " + str(Left_side_percentage), (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 210, 0), 2)
                    cv2.putText(self.frame, "Looking at Left " + str(Right_side_percentage), (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 100, 10), 2)
